...
export function createStarterPrompts() {
  return [
    // MILD
    { id: uid(), type: "truth", spice: "mild", partnered: false, duration: null, text: "What's the most adventurous thing you've ever done in, or out of, the bedroom?" },
    ...
    { id: uid(), type: "truth", spice: "mild", partnered: false, duration: null, text: "Who here do you think has the best moves, and why?" },
    ...
    { id: uid(), type: "truth", spice: "medium", partnered: false, duration: null, text: "Describe exactly what you'd like to do to the person you find most attractive here." },
    ...
    // HOT
    { id: uid(), type: "truth", spice: "hot", partnered: false, duration: null, text: "What's something you'd like to do more often in, or out of, the bedroom?" },
    { id: uid(), type: "truth", spice: "hot", partnered: false, duration: null, text: "What's a fantasy you've never told anyone here?" },
    ...
    { id: uid(), type: "dare", spice: "hot", partnered: false, duration: null, text: "Remove one item of clothing of {partner}s choosing." },
