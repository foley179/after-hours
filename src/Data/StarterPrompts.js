...
export const STARTER_PROMPTS = [
  ...
  { id: uid(), type: "dare", spice: "hot", partnered: true, duration: 120, text: "Make out with {partner} for a full two minutes." },
  { id: uid(), type: "dare", spice: "hot", partnered: false, duration: null, text: "Strip down to whatever you're comfortable with and stay that way for three rounds." },
  { id: uid(), type: "dare", spice: "hot", partnered: true, duration: 30, text: "Blindfolded — try to identify {partner} by touch alone for 30 seconds." },
  { id: uid(), type: "dare", spice: "hot", partnered: false, duration: 20, text: "Strip down completely for 20 seconds, then get dressed again." },
];